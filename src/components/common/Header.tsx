...
import { RequestAQuoteForm } from '@/components/request-a-quote/RequestAQuoteForm';
    ...
    <>
      <header className={`sticky top-0 z-50 transition-all duration-300 ${
        ...
        <div className="container mx-auto">
          <div className="flex items-center justify-between h-20">
                ...
                <div className="flex justify-center items-center py-4">
                  <div className="relative">
                    <img
                      src="/logo.png"
                      alt="Logo"
                      className="w-20 sm:w-24 md:w-28 lg:w-48 object-contain"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button 
                ...
                className="hidden lg:flex items-center space-x-2 bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-700 hover:to-teal-700 text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 shadow-lg hover:shadow-xl group transform hover:-translate-y-0.5"
              >
          ...
          {/* Mobile Menu */}
          {isMenuOpen && (
            <div className="lg:hidden absolute top-full left-0 w-full bg-white shadow-2xl border-t border-gray-100 py-4 animate-slide-up">
              <div className="container mx-auto px-4">
                ...
                <div className="mt-6 pt-6 border-t border-gray-100 space-y-4">
                  <button 
                    ...
                    className="w-full bg-gradient-to-r from-cyan-600 to-teal-600 text-white py-3 rounded-full font-semibold flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    <span>Request A Quote</span>
      ...
      <Dialog open={isQuoteModalOpen} onOpenChange={setIsQuoteModalOpen}>
        <DialogContent className="dialog-content max-w-5xl w-full mx-4">
          <RequestAQuoteForm 
