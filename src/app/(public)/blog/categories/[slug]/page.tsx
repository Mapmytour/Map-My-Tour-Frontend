...
import { useCategoryPosts } from '@/hooks/use-blog';
...
import { BookOpen, Grid, List, Filter, ArrowUpDown } from 'lucide-react';
      ...
      <section className="py-16 bg-gradient-to-r from-primary to-purple-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            {/* Breadcrumb */}
            <nav className="flex items-center justify-center gap-2 text-sm text-blue-100 mb-6">
              <Link href="/" className="hover:text-white transition-colors">Home</Link>
              <span>/</span>
              <Link href="/blog" className="hover:text-white transition-colors">Blog</Link>
              <span>/</span>
              <Link href="/blog/categories" className="hover:text-white transition-colors">Categories</Link>
              <span>/</span>
            ...
            <div className="flex items-center justify-center gap-8 mt-8 text-blue-100">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-white">
                  {Math.round(posts.reduce((sum, post) => sum + (post.readingTime || 0), 0) / posts.length) || 0}
                </div>
                ...
                <div className={
                  ...
                  {posts.map((post) => (
                    <BlogPostCard
                      ...
                      showAuthor={true}
                      showDate={true}
                      showCategories={false} // Don't show category since we're in category view
